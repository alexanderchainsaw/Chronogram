...
async def command_inbox(message: Message, state: FSMContext, l10n: L10N):
    ...
    if not received_messages:
        await message.answer(
            text=await start_inbox_caption(message.from_user.id, empty=True, l10n=l10n),
...
async def process_inbox_callback(
    callback_query: CallbackQuery, callback_data: InboxCallback, l10n: L10N
):
