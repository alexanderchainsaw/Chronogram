EN: dict[str, str] = {
    ...
    "/refund": {"no_refunds": "Refunds are not available with this bot",
                ...
                "success": "Done"},
    "/timecapsule": {"init": "<b>Let's create a time capsule</b>\n\n"
                             "Here are some rules:\n"
                     ...
                     "not_enough_space": {"common": "You dont have enough space to send this time capsule",
    ...
    "/inbox": {"init": "<b>Here are your saved time capsules.\n\n {} ({}) space left</b>",
    ...
    "/subscription": {"init_subscribed": "<b>Subscriptions</b>"
    ...
    "/delete_everything": {'init': "<b>Delete Everything</b>\n\n"
